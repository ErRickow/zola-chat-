...
const NeosantaraLogo: React.FC < NeosantaraLogoSvgProps > = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" style="shape-rendering:geometricPrecision;text-rendering:geometricPrecision;image-rendering:optimizeQuality;fill-rule:evenodd;clip-rule:evenodd">
